    ...
    def self.available_options
      ...
      [
        ...
        FastlaneCore::ConfigItem.new(key: :skip_submission,
                                     ...
                                     is_string: false,
                                     default_value: false),
        FastlaneCore::ConfigItem.new(key: :return_when_build_appears,
                                     env_name: "PILOT_RETURN_WHEN_BUILD_APPEARS",
                                     description: "Wait only for the build to appear on AppStoreConnect, skip waiting for processing to finish",
                                     is_string: false,
                                     default_value: false),
